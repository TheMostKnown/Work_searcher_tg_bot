...
# setting up bot and handler of user's data
bot = telebot.TeleBot(TOKEN)
user = Scrapper()


# processing of commands entered by user
...
# in any unknown situation advice user to use /help
@bot.message_handler(content_types=['text'])
def get_text_messages(message):
    bot.send_message(
        message.from_user.id, 'This is a work searcher bot\nType /help to see the commands'
        )


# function of setting the user's experience
...
# function of setting the user's specialization
...
# function that checks if user wants to continue searching for job with this parameters
...
# one iteration of searching. Displays one opportunity
...
# making bot working while script is active
